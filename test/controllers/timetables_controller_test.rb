...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { created_at: @timetable.created_at, enddate: @timetable.enddate, startdate: @timetable.startdate, task_id: @timetable.task_id, taskname: @timetable.taskname, updated_at: @timetable.updated_at, weekday: @timetable.weekday }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { created_at: @timetable.created_at, enddate: @timetable.enddate, startdate: @timetable.startdate, task_id: @timetable.task_id, taskname: @timetable.taskname, updated_at: @timetable.updated_at, weekday: @timetable.weekday }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
